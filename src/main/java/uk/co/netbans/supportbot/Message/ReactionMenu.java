...
public class ReactionMenu extends ListenerAdapter {
    ...
    public void display(TextChannel channel) {
        ...
        message = bot.getNewMessenger().sendMessage(channel, unsentMessage.build(), -1);
    ...
    public void removeReaction(String name) {
        message.refreshMessage(bot.getJDA());
    ...
    public static class Builder {
        ...
        public ReactionMenu build() {
            ReactionMenu menu = new ReactionMenu(bot, message, startingReactions, openEvents, closeEvents, addActions, removeActions, removeReactions);
            bot.getJDA().addEventListener(menu);
            return menu;
        }
