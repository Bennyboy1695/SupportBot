...
public class List {
    ...
    @Command(name = "perm~list", displayName = "list", aliases = "permission~list,perms~list", permission = "supportbot.command.admin.perm.list", usage = "perm list <groups|user|group>")
