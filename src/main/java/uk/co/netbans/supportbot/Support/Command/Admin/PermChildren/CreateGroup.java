...
public class CreateGroup {
    ...
    @Command(name = "perm~creategroup", displayName = "creategroup",aliases = "perms~creatgroup,permission~creategroup", permission = "supportbot.command.admin.perm.creategroup", usage = "perm creategroup <groupname> [<child|role> <role>]")
