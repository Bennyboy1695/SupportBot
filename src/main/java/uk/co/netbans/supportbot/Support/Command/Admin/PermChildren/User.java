...
public class User{
    ...
    @Command(name = "perm~user", displayName = "user", aliases = "permission~user,perms~user", permission = "supportbot.command.admin.perm.user", usage = "perm user <user> <add|set|remove> <perm|group>")
